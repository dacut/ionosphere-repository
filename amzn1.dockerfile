...
ENTRYPOINT ["/bin/sh", "-c", "echo ARCH=\"$ARCH\" 1>&2; ls /usr/src/rpm/RPMS/$ARCH; mkdir -p /export/SRPMS && mkdir -p /export/RPMS && cp /usr/src/rpm/SRPMS/* /export/SRPMS/ && cp /usr/src/rpm/RPMS/$ARCH/* /export/RPMS/"]
